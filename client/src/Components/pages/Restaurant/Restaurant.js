    ...
    return (
      <div>
        ...
        <p className="restaurant_description">
          ...
          <br /><br /><br />
          tel: {item.phone}
          { item.fax ? <span><br /><br /><br /> {item.fax}</span> : ""}
          <br /><br /><br />
          {item.website}
          {/* Site de gilles */}
          { item.portfolio ? <span><br /><br /><br /> {item.portfolio}</span> : ""}
          {/* Mail de gilles */}
          { item.mail ? <span><br /><br /><br /> {item.mail}</span> : ""}
          {/* Comment s'y rendre en métro */}
          { item.way ? <span><br /><br /><br /> {item.way}</span> : ""}
          <br /><br /><br />
          {item.schedules}
        </p>
        </div>
